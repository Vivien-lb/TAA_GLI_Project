...
class StudentGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Student entity")
        ...
        .repeat(2) {
            ...
            .post("/api/students")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "firstName":"SAMPLE_TEXT", "lastName":"SAMPLE_TEXT", "speciality":"SAMPLE_TEXT", "mail":"SAMPLE_TEXT", "phone":"SAMPLE_TEXT", "adress":"SAMPLE_TEXT", "birthDate":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))
